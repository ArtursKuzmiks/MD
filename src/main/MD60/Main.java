...
class MdGUI extends JFrame {
    ...
    MdGUI() {
        ...
        final Border border = BorderFactory.createLineBorder(Color.RED, 1);
        final String title = "Md_3, MAU";
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            for (int i = 0; i < list1Model.getSize(); i++) {
                ...
                for (String aSplit : split) {
                    for (int n = 0; n < aSplit.length(); n++) {
                        if (n % 2 == 0)
                            temp.append(aSplit.charAt(n));
                        else
                            temp.append(aSplit.charAt(n)).append("mau");
                    }
                    temp.append(" ");
                }
