        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            for (int i = 0; i < list1Model.getSize(); i++) {
                ...
                for (int j = 0; j < list1Model.get(i).length(); j++) {
                    String temp = String.valueOf(list1Model.get(i).charAt(j));
                    int count = 0;
                    if (temp.matches("[a-zA-Z]")) {
                        for (int n = 0; n < list1Model.get(i).length(); n++) {
                            if (temp.equalsIgnoreCase(String.valueOf(list1Model.get(i).charAt(n))))
                                count++;
                        }
                        if (count > 1){
                            found = true;
